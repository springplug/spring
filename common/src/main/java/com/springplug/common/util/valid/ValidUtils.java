package com.springplug.common.util.valid;

import com.springplug.common.util.string.StringUtils;

public class ValidUtils {

    public static final String mobile = "^1(2|3|4|5|6|7|8|9)\\d{9}$";

    public static final String codeAndMobile = "^\\+[0-9]{2}\\-(13|15|18|17|16)[0-9]{9}$";

    public static final String idCard="^(\\d{18,18}|\\d{15,15}|(\\d{17,17}[x|X]))$";

    public static final String bankCard="^\\d{19}$";
    ...
    public static final String tel = "^(([0\\+]\\d{2,3}-)?(0\\d{2,3})-)?(\\d{7,8})(-(\\d{1,}))?$";
    ...
    public static final String letterAndSpace = "^[A-Za-z ]+$";
    ...
    public static final String isUFloat = "^\\d+(\\.\\d+)?$";

    /**
     * 判断是否是整数
     */

    public static final String isInteger = "^[-]?\\d+$";

    /**
     * 判断是否是正整数
     */

    public static final String isUInteger = "^\\d+$";

    /**
     * 判断车辆Vin码
     */

    public static final String isCarVin = "^[1234567890WERTYUPASDFGHJKLZXCVBNM]{13}[0-9]{4}$";
